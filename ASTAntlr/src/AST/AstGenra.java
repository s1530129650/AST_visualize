...
public class AstGenra {
    ...
    private static String readFile() throws IOException {
        //File file = new File("D:/v-enshi/AST——visual/example/Student.java");
    	File file = new File("D:/v-enshi/AST——visual/example/inta.txt");
    ...
    public static void main(String args[]) throws IOException{
       ...
       // ParserRuleContext ctx = parser.compilationUnit();
        ParserRuleContext ctx = parser. fieldDeclaration();
        //ParserRuleContext ctx = parser.statement();
